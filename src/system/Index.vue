    ...
    <el-header class="header-container" style="padding: 0;" v-if="showHeader">
      ...
      <div class="header-ops">
        <div style="display: flex;">
          ...
          <a class="btn" title="中文" @click="onChangeLang('zh')"> 中文</a>
          <a class="btn" title="English" @click="onChangeLang('en')"> English</a>
          <!-- 焦点模式 -->
          <a class="btn" title="进入焦点模式" @click="enterFocusMode()"><i class="el-icon-full-screen"></i></a>
          <!-- 注销 -->
          <a class="btn" title="退出" @click="logout"><i class="el-icon-switch-button"></i></a>
  ...
  .container {
    ...
    .header-container {
      ...
      .header-logo {
        ...
        padding: 0 10px;
        background-color: #409EFF;
        background-image: url("../assets/logoIndex.png");
