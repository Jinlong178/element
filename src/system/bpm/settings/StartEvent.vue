  ...
  export default {
    ...
    data() {
      return {
        ...
        matchElementArray: ['bpmn:StartEvent'],
        eventDefinitionArray: ['bpmn:TimerEventDefinition', 'bpmn:MessageEventDefinition', 'bpmn:SignalEventDefinition', 'bpmn:ConditionalEventDefinition'],
      }
    },
    watch: {
      element(value) {
